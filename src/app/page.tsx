...
export default function Home() {
  ...
  const events = [
    ...
    },
    {
      ...
      details:
        "Celebrate major festivals with us. See the calendar for upcoming dates.",
    },
    {
      ...
      tithi: "9 AM",
      details:
        "Participate in our monthly community service and make a difference.",
    },
  ];
  ...
  return (
    <div className="w-full min-h-screen bg-[#FFF9E5] flex flex-col items-center">
      ...
      >
        Welcome to{" "}
        <span className="text-yellow-500 drop-shadow">
      ...
      >
        ...
        <span className="font-semibold text-yellow-700">
          Discover the peace and tranquility that our temple offers.
        </span>
      </motion.p>
      ...
      <div ref={sliderRef} className="w-full flex justify-center min-h-[24rem]">
        {showSlider && (
          <motion.div
